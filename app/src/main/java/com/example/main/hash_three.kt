...
import kotlinx.android.synthetic.main.activity_hash2.rvs_profile
import kotlinx.android.synthetic.main.activity_main_home.*
import kotlinx.android.synthetic.main.activity_monthjang.*
import kotlinx.android.synthetic.main.main_drawer_header.*
import java.util.*

class hash_three : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hash_three)
        ...
        //3학점 이상 장학금과 연관된 데이터를 찾아옴. 1로 되어있으면 연관/0으로 되어있으면 연관되지 않음
        var a = "1"
        cursor = sqlitedb.rawQuery("SELECT * FROM august_day WHERE tgrade = '"+a+"';", null)
        ...
        cursor2 = sqlitedb.rawQuery("SELECT * FROM august_day WHERE tgrade = '"+a+"';", null)
